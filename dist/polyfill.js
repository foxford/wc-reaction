  ...
  */
  (function () {
    ...
    if ("function" == typeof Object.setPrototypeOf) ka = Object.setPrototypeOf;else {
      var la;a: {
        var ma = { Oa: !0 },
            na = {};try {
          na.__proto__ = ma;la = na.Oa;break a;
        } catch (a) {}la = !1;
      }ka = la ? function (a, b) {
    ...
    function wa(a, b, c, d) {
      ...
      for (; a.a.a;) {
        ...
        b = a.a.c;a.a.c = null;if (b.Ua) throw b.Qa;return { value: b.return, done: !0 };
    ...
    (function () {
      ...
      function a() {}function b(a, b) {
        if (!a.childNodes.length) return [];switch (a.nodeType) {case Node.DOCUMENT_NODE:
            return ua.call(a, b);case Node.DOCUMENT_FRAGMENT_NODE:
            return hf.call(a, b);default:
            return A.call(a, b);}
        ...
        function a(a, b) {
          ...
          ua = Document.prototype.querySelectorAll,
          hf = DocumentFragment.prototype.querySelectorAll,
          jf = function () {
        if (!c) {
        ...
        var da = document.implementation.createHTMLDocument("template"),
            Fc = !0,
            q = document.createElement("style");q.textContent = "template{display:none;}";var Gc = document.head;Gc.insertBefore(q, Gc.firstElementChild);a.prototype = Object.create(HTMLElement.prototype);var kf = !document.createElement("div").hasOwnProperty("innerHTML");a.R = function (b) {
          if (!b.content && b.namespaceURI === document.documentElement.namespaceURI) {
            b.content = da.createDocumentFragment();
            for (var c; c = b.firstChild;) {
              m.call(b.content, c);
            }if (kf) b.__proto__ = a.prototype;else if (b.cloneNode = function (b) {
              return a.b(this, b);
            }, Fc) try {
              l(b), D(b);
            } catch (rh) {
        ...
        };var qb = { option: ["select"], thead: ["table"], col: ["colgroup", "table"], tr: ["tbody", "table"], th: ["tr", "tbody", "table"], td: ["tr", "tbody", "table"] },
            l = function l(b) {
          ...
          }, configurable: !0, enumerable: !0 });var lf = /[&\u00A0"]/g,
            mf = /[&\u00A0<>]/g,
            Hc = function Hc(a) {
          switch (a) {case "&":
              return "&amp;";case "<":
        ...
        };var nf = q("area base br col command embed hr img input keygen link meta param source track wbr".split(" ")),
            of = q("style script xmp iframe noembed noframes plaintext noscript".split(" ")),
            rb = function rb(a, b) {
            ...
            a: {
              var h = g;var k = a;var m = b;switch (h.nodeType) {case Node.ELEMENT_NODE:
                  for (var n = h.localName, l = "<" + n, p = h.attributes, A = 0; k = p[A]; A++) {
                    l += " " + k.name + '="' + k.value.replace(lf, Hc) + '"';
                  }l += ">";h = nf[n] ? l : l + rb(h, m) + "</" + n + ">";break a;case Node.TEXT_NODE:
                  h = h.data;h = k && of[k.localName] ? h : h.replace(mf, Hc);break a;
        ...
        a.b = function (a, b) {
          var c = f.call(a, !1);this.R && this.R(c);b && (m.call(c.content, f.call(a.content, !0)), sb(c.content, a.content));return c;
        };var sb = function sb(c, d) {
          if (d.querySelectorAll && (d = b(d, "template"), 0 !== d.length)) {
            c = b(c, "template");for (var e = 0, f = c.length, g, h; e < f; e++) {
              h = d[e], g = c[e], a && a.R && a.R(h), n.call(g.parentNode, pf.call(h, !0), g);
            }
          }
        },
            pf = Node.prototype.cloneNode = function (b) {
          if (!e && d && this instanceof DocumentFragment) {
            if (b) var c = qf.call(this.ownerDocument, this, !0);else return this.ownerDocument.createDocumentFragment();
          } else this.nodeType === Node.ELEMENT_NODE && "template" === this.localName && this.namespaceURI == document.documentElement.namespaceURI ? c = a.b(this, b) : c = f.call(this, b);b && sb(c, this);return c;
        },
            qf = Document.prototype.importNode = function (c, d) {
          d = d || !1;if ("template" === c.localName) return a.b(c, d);var e = h.call(this, c, d);if (d) {
            sb(e, c);c = b(e, 'script:not([type]),script[type="application/javascript"],script[type="text/javascript"]');
      ...
      if (!(this instanceof t)) throw new TypeError("Promises must be constructed via new");if ("function" !== typeof a) throw new TypeError("not a function");this.J = 0;this.va = !1;this.A = void 0;this.U = [];Ea(a, this);
    }
    function Fa(a, b) {
      for (; 3 === a.J;) {
        a = a.A;
      }0 === a.J ? a.U.push(b) : (a.va = !0, t.a(function () {
        var c = 1 === a.J ? b.Wa : b.Xa;if (null === c) (1 === a.J ? Ga : Ha)(b.qa, a.A);else {
          try {
            var d = c(a.A);
          } catch (e) {
            Ha(b.qa, e);return;
    ...
    function Ha(a, b) {
      ...
      this.Wa = "function" === typeof a ? a : null;this.Xa = "function" === typeof b ? b : null;this.qa = c;
    }function Ea(a, b) {
      var c = !1;try {
        a(function (a) {
          c || (c = !0, Ga(b, a));
    ...
    if (!window.Promise && (window.Promise = t, t.prototype.then = t.prototype.then, t.all = t.c, t.race = t.f, t.resolve = t.resolve, t.reject = t.reject, !window.setImmediate)) {
      ...
      b = void 0 === b ? {} : b;return { value: a, configurable: !!b.wa, writable: !!b.eb, enumerable: !!b.e };
    }var Qa = void 0;try {
      ...
      a = String(a);for (var b = "", c = 0; Ra[a + b];) {
        b = c += 1;
          ...
          Pa(this, d, u(a, { wa: !0, eb: !0 }));
        }, configurable: !0, enumerable: !1 });return d;
    }var Ta = Na(null);
    function v(a) {
      if (this instanceof v) throw new TypeError("Symbol is not a constructor");a = void 0 === a ? "" : String(a);var b = Sa(a);return Qa ? Na(Ta, { sa: u(a), Ia: u(b) }) : b;
        ...
        if (Qa && (!a || "Symbol" !== a[v.toStringTag])) throw new TypeError("" + a + " is not a symbol");for (var b in Ma) {
          if (Ma[b] === a) return Qa ? Ma[b].sa : Ma[b].substr(7, Ma[b].length - 8);
        }
      }) });
    Oa(v, { vb: u(v("hasInstance")), wb: u(v("isConcatSpreadable")), iterator: u(v("iterator")), match: u(v("match")), replace: u(v("replace")), search: u(v("search")), yb: u(v("species")), split: u(v("split")), zb: u(v("toPrimitive")), toStringTag: u(v("toStringTag")), unscopables: u(v("unscopables")) });Oa(Ta, { constructor: u(v), toString: u(function () {
        ...
        return "Symbol(" + this.sa + ")";
      }) });Qa && Pa(Ta, v.toStringTag, u("Symbol", { wa: !0 }));var Ua = "function" === typeof Symbol ? Symbol : v; /*
                                                                                                                     Copyright (c) 2018 The Polymer Project Authors. All rights reserved.
                                                                                                                     This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
                                                                                                                     The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
                                                                                                                     The complete set of contributors may be found at http://polymer.github.io/CONTRIBUTORS.txt
    ...
    window.WebComponents.flags = w;var ab = w.shadydom;ab && (window.ShadyDOM = window.ShadyDOM || {}, window.ShadyDOM.force = ab);var bb = w.register || w.ce;bb && window.customElements && (window.customElements.forcePolyfill = bb); /*
                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                          */
    function cb() {
      this.za = this.root = null;this.da = !1;this.N = this.$ = this.ma = this.assignedSlot = this.assignedNodes = this.S = null;this.childNodes = this.nextSibling = this.previousSibling = this.lastChild = this.firstChild = this.parentNode = this.V = void 0;this.Ea = this.ta = !1;this.Z = {};
      ...
      return a && a.ka;
    }var z = window.ShadyDOM || {};z.Sa = !(!Element.prototype.attachShadow || !Node.prototype.getRootNode);var db = Object.getOwnPropertyDescriptor(Node.prototype, "firstChild");z.K = !!(db && db.configurable && db.get);z.oa = z.force || !z.Sa;var eb = navigator.userAgent.match("Trident"),
        fb = navigator.userAgent.match("Edge");void 0 === z.Ba && (z.Ba = z.K && (eb || fb));function gb(a) {
    ...
    }).observe(nb, { characterData: !0 });function tb(a) {
      pb.push(a);nb.textContent = ob++;
    }var ub = !!document.contains;function vb(a, b) {
      for (; b;) {
    ...
    function Db(a, b) {
      var c = x(a);c.S || (c.S = new Bb());c.S.ca.add(b);var d = c.S;return { Ja: b, P: d, La: a, takeRecords: function takeRecords() {
          return d.takeRecords();
        } };
    }function Eb(a) {
      var b = a && a.P;b && (b.ca.delete(a.Ja), b.ca.size || (x(a.La).S = null));
    }
    function Fb(a, b) {
    ...
    function fc(a, b) {
      "template" === a.localName && (a = a.content);for (var c = "", d = b ? b(a) : a.childNodes, e = 0, f = d.length, g; e < f && (g = d[e]); e++) {
        a: {
          var h = g;var k = a;var m = b;switch (h.nodeType) {case Node.ELEMENT_NODE:
              for (var n = h.localName, p = "<" + n, G = h.attributes, B = 0; k = G[B]; B++) {
        ...
        H = document.createTreeWalker(document, NodeFilter.SHOW_ELEMENT, null, !1);function gc(a) {
    ...
    I.lastElementChild = function (a) {
      ...
      var b = [];H.currentNode = a;for (a = H.firstChild(); a;) {
        b.push(a), a = H.nextSibling();
      }return wb(b);
    ...
    var K = hc ? { parentNode: J("parentNode"), firstChild: J("firstChild"), lastChild: J("lastChild"), previousSibling: J("previousSibling"), nextSibling: J("nextSibling"), childNodes: J("childNodes"), parentElement: J("parentElement"), previousElementSibling: J("previousElementSibling"), nextElementSibling: J("nextElementSibling"), innerHTML: J("innerHTML"), textContent: J("textContent"), firstElementChild: J("firstElementChild"), lastElementChild: J("lastElementChild"), children: J("children") } : {},
        ...
        lc = { ya: K, sb: jc, mb: kc, parentNode: function parentNode(a) {
      ...
      nextSibling: { get: function get$$1() {
        ...
        uc = { childNodes: { get: function get$$1() {
          ...
          if ("undefined" === typeof a || null === a) a = "";switch (this.nodeType) {case Node.ELEMENT_NODE:case Node.DOCUMENT_FRAGMENT_NODE:
              if (!gb(this) && nc) {
                var b = this.firstChild;(b != this.lastChild || b && b.nodeType != Node.TEXT_NODE) && mc(this);lc.ya.textContent.set.call(this, a);
          ...
          var b = "template" === this.localName ? this.content : this;mc(b);var c = this.localName || "div";c = this.namespaceURI && this.namespaceURI !== oc.namespaceURI ? oc.createElementNS(this.namespaceURI, c) : oc.createElement(c);nc ? lc.ya.innerHTML.set.call(c, a) : c.innerHTML = a;for (a = "template" === this.localName ? c.content : c; a.firstChild;) {
            b.appendChild(a.firstChild);
          }
        },
        configurable: !0 } },
        vc = { shadowRoot: { get: function get$$1() {
          var a = y(this);return a && a.za || null;
        }, configurable: !0 } },
    ...
    function yc() {
      ...
      var b = x(a);b.ta || (b.ta = !0, M(a, sc, !0), M(a, tc, !0));
    },
        Bc = z.K ? function () {} : function (a) {
      x(a).Ea || (M(a, uc, !0), M(a, vc, !0));
    ...
    function Jc(a, b, c) {
      if (b === a) throw Error("Failed to execute 'appendChild' on 'Node': The new child element contains the parent.");if (c) {
        var d = y(c);d = d && d.parentNode;if (void 0 !== d && d !== a || void 0 === d && Ic(c) !== a) throw Error("Failed to execute 'insertBefore' on 'Node': The node before which the new node is to be inserted is not a child of this node.");
      }if (c === b) return b;b.parentNode && Kc(b.parentNode, b);var e, f;if (!b.__noInsertionPoint) {
        if (f = e = hb(a)) {
          var g;"slot" === b.localName ? g = [b] : b.querySelectorAll && (g = b.querySelectorAll("slot"));f = g && g.length ? g : void 0;
        }f && (g = e, d = f, g.a = g.a || [], g.o = g.o || [], g.w = g.w || {}, g.a.push.apply(g.a, d instanceof Array ? d : Aa(ja(d))));
        ...
        } else Dc(b, a, e);e = y(a);if (Mc(a)) {
          Lc(e.root);var h = !0;
        } else e.root && (h = !0);
      }h || (h = C(a) ? a.host : a, c ? (c = Nc(c), E.insertBefore.call(h, b, c)) : E.appendChild.call(h, b));Oc(a, b);return b;
    }
    function Kc(a, b) {
            ...
            for (g = f[A], h = 0; h < g.length; h++) {
              var m = g[h];if (vb(b, m)) {
                g.splice(h, 1);var n = c.o.indexOf(m);0 <= n && c.o.splice(n, 1);h--;n = y(m);if (m = n.N) for (var p = 0; p < m.length; p++) {
                  var G = m[p],
                      B = Rc(G);B && E.removeChild.call(B, G);
                }n.N = [];n.assignedNodes = [];n = !0;
              }
            }
          }var A = n;
        } else A = void 0;(A || e) && Lc(c);
      }k || (k = C(a) ? a.host : a, (!d.root && "slot" !== b.localName || k === Ic(b)) && E.removeChild.call(k, b));Oc(a, null, b);return b;
    }
    function Pc(a) {
    ...
    var hd = { get composed() {
        ...
        this.ra || (this.ra = fd(this.__target, this.composed));return this.ra;
      }, get target() {
        return gd(this.currentTarget || this.__previousCurrentTarget, this.composedPath());
      }, get relatedTarget() {
        if (!this.ja) return null;this.ua || (this.ua = fd(this.ja, !0));return gd(this.currentTarget, this.ua);
      }, stopPropagation: function stopPropagation() {
        Event.prototype.stopPropagation.call(this);this.ia = !0;
      }, stopImmediatePropagation: function stopImmediatePropagation() {
        Event.prototype.stopImmediatePropagation.call(this);this.ia = this.Da = !0;
      } };function id(a) {
      function b(b, d) {
      ...
      if (c = b.__handlers && b.__handlers[a.type] && b.__handlers[a.type][c]) for (var d = 0, e; (e = c[d]) && (!kd(a) || a.target !== a.relatedTarget) && (e.call(b, a), !a.Da); d++) {}
    }
    function md(a) {
    ...
    function zc(a, b, c) {
      if (a !== Ad) throw new TypeError("Illegal constructor");this.Ka = "ShadyRoot";this.host = b;this.c = c && c.mode;Ec(b);a = x(b);a.root = this;a.za = "closed" !== this.c ? this : null;a = x(this);a.firstChild = a.lastChild = a.parentNode = a.nextSibling = a.previousSibling = null;a.childNodes = [];this.b = this.aa = !1;this.a = this.w = this.o = null;Lc(this);
    }function Lc(a) {
    ...
    function Qc(a) {
      ...
      var b = a.name || a.getAttribute("name") || "__catchall";return a.Ha = b;
    }function Vc(a) {
    ...
    if (window.customElements && z.oa) {
      var Id = new Map();Cd = function Cd() {
        var a = Array.from(Id);Id.clear();a = ja(a);for (var b = a.next(); !b.done; b = a.next()) {
          b = ja(b.value);var c = b.next().value;b.next().value ? c.Fa() : c.Ga();
        }
      };Bd && document.addEventListener("readystatechange", function () {
        Bd = !1;Cd();
      }, { once: !0 });var Jd = function Jd(a, b, c) {
        var d = 0,
            e = "__isConnected" + d++;if (b || c) a.prototype.connectedCallback = a.prototype.Fa = function () {
    ...
    Object.defineProperties(Md, { isConnected: { get: function get$$1() {
          if (qc && qc.call(this)) return !0;if (this.nodeType == Node.DOCUMENT_FRAGMENT_NODE) return !1;var a = this.ownerDocument;if (ub) {
    ...
    T.prototype.upgrade = T.prototype.ha;T.prototype.get = T.prototype.get;T.prototype.whenDefined = T.prototype.Ca;T.prototype.polyfillWrapFlushCallback = T.prototype.Ya;var le = window.Document.prototype.createElement,
    ...
    function ef(a, b) {
      var c = b.substring(a.start, a.end - 1);a.parsedCssText = a.cssText = c.trim();a.parent && (c = b.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1), c = ff(c), c = c.replace(gf, " "), c = c.substring(c.lastIndexOf(";") + 1), c = a.parsedSelector = a.selector = c.trim(), a.atRule = 0 === c.indexOf("@"), a.atRule ? 0 === c.indexOf("@media") ? a.type = rf : c.match(sf) && (a.type = tf, a.keyframesName = a.selector.split(gf).pop()) : a.type = 0 === c.indexOf("--") ? uf : vf);if (c = a.rules) for (var d = 0, e = c.length, f; d < e && (f = c[d]); d++) {
        ef(f, b);
      }return a;
    }function ff(a) {
    ...
    var vf = 1,
      ...
      return !!a.parent && a.parent.type === tf;
    }function Lf(a, b, c, d) {
      if (a) {
        var e = !1,
            f = a.type;if (d && f === rf) {
          var g = a.selector.match(Hf);g && (window.matchMedia(g[1]).matches || (e = !0));
        }f === vf ? b(a) : c && f === tf ? c(a) : f === uf && (e = !0);if ((a = a.rules) && !e) {
    ...
    function Rf(a, b) {
      ...
      }d = a.substring(c + 4, e);c = a.substring(0, c);a = Rf(a.substring(e + 1), b);e = d.indexOf(",");return -1 === e ? b(c, d.trim(), "", a) : b(c, d.substring(0, e).trim(), d.substring(e + 1).trim(), a);
    }function Sf(a, b) {
    ...
    }function Uf() {}function Vf(a, b) {
      var c = W;a.__styleScoped ? a.__styleScoped = null : Wf(c, a, function (a) {
        Xf(a, b || "");
      });
    }function Wf(a, b, c) {
    ...
    function Xf(a, b, c) {
      if (b) if (a.classList) c ? (a.classList.remove("style-scope"), a.classList.remove(b)) : (a.classList.add("style-scope"), a.classList.add(b));else if (a.getAttribute) {
        var d = a.getAttribute(Yf);c ? d && (b = d.replace("style-scope", "").replace(b, ""), Sf(a, b)) : Sf(a, (d ? d + " " : "") + "style-scope " + b);
      }
    }function Zf(a, b, c) {
      var d = W;a.__styleScoped ? a.__styleScoped = null : Wf(d, a, function (a) {
        Xf(a, b, !0);Xf(a, c);
      });
    }function $f(a, b) {
      var c = W;a.__styleScoped ? a.__styleScoped = null : Wf(c, a, function (a) {
    ...
    function ag(a, b, c) {
      var d = W,
          e = a.__cssBuild;U || "shady" === e ? b = Kf(b, c) : (a = Tf(a), b = bg(d, b, a.is, a.X, c) + "\n\n");return b.trim();
    }function bg(a, b, c, d, e) {
      var f = cg(c, d);c = c ? dg + c : "";return Kf(b, function (b) {
        b.c || (b.selector = b.F = eg(a, b, a.b, c, f), b.c = !0);e && e(b, c, f);
      });
    }function cg(a, b) {
      return b ? "[is=" + a + "]" : a;
    }function eg(a, b, c, d, e) {
      var f = b.selector.split(fg);if (!Nf(b)) {
    ...
    function gg(a) {
      return a.replace(hg, function (a, c, d) {
        -1 < d.indexOf("+") ? d = d.replace(/\+/g, "___") : -1 < d.indexOf("___") && (d = d.replace(/___/g, "+"));return ":" + c + "(" + d + ")";
      });
    }Uf.prototype.b = function (a, b, c) {
      var d = !1;a = a.trim();var e = hg.test(a);e && (a = a.replace(hg, function (a, b, c) {
        return ":" + b + "(" + c.replace(/\s/g, "") + ")";
      }), a = gg(a));a = a.replace(ig, jg + " $1");a = a.replace(kg, function (a, e, h) {
        d || (a = lg(h, e, b, c), d = d || a.stop, e = a.Pa, h = a.value);return e + h;
      });e && (a = gg(a));return a;
    };
    function lg(a, b, c, d) {
      var e = a.indexOf(mg);0 <= a.indexOf(jg) ? a = ng(a, d) : 0 !== e && (a = c ? og(a, c) : a);c = !1;0 <= e && (b = "", c = !0);if (c) {
        var f = !0;c && (a = a.replace(pg, function (a, b) {
          return " > " + b;
        }));
      }a = a.replace(qg, function (a, b, c) {
        return '[dir="' + c + '"] ' + b + ", " + b + '[dir="' + c + '"]';
      });return { value: a, Pa: b, stop: f };
    }function og(a, b) {
      a = a.split(rg);a[0] += b;return a.join(rg);
    }
    function ng(a, b) {
      var c = a.match(sg);return (c = c && c[2].trim() || "") ? c[0].match(tg) ? a.replace(sg, function (a, c, f) {
        return b + f;
      }) : c.split(tg)[0] === b ? c : ug : a.replace(jg, b);
    }function vg(a) {
      a.selector === wg && (a.selector = "html");
    }Uf.prototype.c = function (a) {
      return a.match(mg) ? this.b(a, xg) : og(a.trim(), xg);
    };ba.Object.defineProperties(Uf.prototype, { a: { configurable: !0, enumerable: !0, get: function get$$1() {
          return "style-scope";
        } } });
    var hg = /:(nth[-\w]+)\(([^)]+)\)/,
        xg = ":not(.style-scope)",
      ...
      return this.M;
    };yg.prototype._getStyleRules = yg.prototype.c;function Ag(a) {
    ...
    }var Bg = navigator.userAgent.match("Trident");function Cg() {}function Dg(a) {
      var b = {},
          c = [],
          d = 0;Lf(a, function (a) {
        Eg(a);a.index = d++;a = a.B.cssText;for (var c; c = Ff.exec(a);) {
          var e = c[1];":" !== c[2] && (b[e] = !0);
        }
      }, function (a) {
        c.push(a);
    ...
    function Eg(a) {
      if (!a.B) {
        var b = {},
            c = {};Fg(a, c) && (b.L = c, a.rules = null);b.cssText = a.parsedCssText.replace(If, "").replace(Df, "");a.B = b;
      }
    }function Fg(a, b) {
      var c = a.B;if (c) {
    ...
    function Gg(a, b, c) {
      b && (b = 0 <= b.indexOf(";") ? Hg(a, b, c) : Rf(b, function (b, e, f, g) {
        if (!e) return b + g;(e = Gg(a, c[e], c)) && "initial" !== e ? "apply-shim-inherit" === e && (e = "inherit") : e = Gg(a, c[f] || f, c) || f;return b + (e || "") + g;
      }));return b && b.trim() || "";
    }
    function Hg(a, b, c) {
      b = b.split(";");for (var d = 0, e, f; d < b.length; d++) {
        if (e = b[d]) {
          Ef.lastIndex = 0;if (f = Ef.exec(e)) e = Gg(a, c[f[1]], c);else if (f = e.indexOf(":"), -1 !== f) {
            var g = e.substring(f);g = g.trim();g = Gg(a, g, c) || g;e = e.substring(0, f) + g;
    ...
    function Ig(a, b) {
      var c = {},
          d = [];Lf(a, function (a) {
        a.B || Eg(a);var e = a.F || a.parsedSelector;b && a.B.L && e && Ag.call(b, e) && (Fg(a, c), a = a.index, e = parseInt(a / 32, 10), d[e] = (d[e] || 0) | 1 << a % 32);
      }, null, !0);return { L: c, key: d };
    }
    function Jg(a, b, c, d) {
      b.B || Eg(b);if (b.B.L) {
        var e = Tf(a);a = e.is;e = e.X;e = a ? cg(a, e) : "html";var f = b.parsedSelector,
            g = ":host > *" === f || "html" === f,
            h = 0 === f.indexOf(":host") && !g;"shady" === c && (g = f === e + " > *." + e || -1 !== f.indexOf("html"), h = !g && 0 === f.indexOf(e));"shadow" === c && (g = ":host > *" === f || "html" === f, h = h && !g);if (g || h) c = e, h && (b.F || (b.F = eg(W, b, W.b, a ? dg + a : "", e)), c = b.F || e), d({ $a: c, Va: h, xb: g });
      }
    }
    function Kg(a, b) {
      var c = {},
        ...
        Jg(a, b, e, function (e) {
          Ag.call(a.lb || a, e.$a) && (e.Va ? Fg(b, c) : Fg(b, d));
        });
      }, null, !0);return { Za: d, Ta: c };
    }
    function Lg(a, b, c, d) {
      var e = Tf(b),
          f = cg(e.is, e.X),
          g = new RegExp("(?:^|[^.#[:])" + (b.extends ? "\\" + f.slice(0, -1) + "\\]" : f) + "($|[.:[\\s>+~])");e = X(b).M;var h = Mg(e, d);return ag(b, e, function (b) {
        var e = "";b.B || Eg(b);b.B.cssText && (e = Hg(a, b.B.cssText, c));b.cssText = e;if (!U && !Nf(b) && b.cssText) {
          var k = e = b.cssText;null == b.xa && (b.xa = Gf.test(e));if (b.xa) if (null == b.ea) {
            b.ea = [];for (var p in h) {
          ...
          }b.cssText = k;b.F = b.F || b.selector;e = "." + d;p = b.F.split(",");k = 0;for (var G = p.length, B; k < G && (B = p[k]); k++) {
      ...
      a = a.b;var c = {};if (!U && a) for (var d = 0, e = a[d]; d < a.length; e = a[++d]) {
        var f = e,
            g = b;f.f = new RegExp("\\b" + f.keyframesName + "(?!\\B|-)", "g");f.a = f.keyframesName + "-" + g;f.F = f.F || f.selector;f.selector = f.F.replace(f.keyframesName, f.a);c[e.keyframesName] = Ng(e);
      }return c;
    }function Ng(a) {
      return function (b) {
    ...
    function Og(a, b) {
      var c = Pg,
        ...
        var d = a.cssText = a.parsedCssText;a.B && a.B.cssText && (d = d.replace(xf, "").replace(yf, ""), a.cssText = Hg(c, d, b));
      });
    }ba.Object.defineProperties(Cg.prototype, { a: { configurable: !0, enumerable: !0, get: function get$$1() {
          return "x-scope";
        } } });var Pg = new Cg();var Qg = {},
        Rg = window.customElements;if (Rg && !U) {
      var Sg = Rg.define;Rg.define = function (a, b, c) {
        var d = document.createComment(" Shady DOM styles for " + a + " "),
            e = document.head;e.insertBefore(d, (Qf ? Qf.nextSibling : null) || e.firstChild);Qf = d;Qg[a] = d;Sg.call(Rg, a, b, c);
      };
    }function Tg() {
      this.cache = {};
    }Tg.prototype.store = function (a, b, c, d) {
      var e = this.cache[a] || [];e.push({ L: b, styleElement: c, I: d });100 < e.length && e.shift();this.cache[a] = e;
    };Tg.prototype.fetch = function (a, b, c) {
      ...
      for (var b = 0; b < a.length; b++) {
        var c = a[b];if (c.target !== document.documentElement && c.target !== document.head) for (var d = 0; d < c.addedNodes.length; d++) {
          var e = c.addedNodes[d];if (e.nodeType === Node.ELEMENT_NODE) {
            var f = e.getRootNode();var g = e;var h = [];g.classList ? h = Array.from(g.classList) : g instanceof window.SVGElement && g.hasAttribute("class") && (h = g.getAttribute("class").split(/\s+/));g = h;h = g.indexOf(W.a);if ((g = -1 < h ? g[h + 1] : "") && f === e.ownerDocument) $f(e, g);else if (f.nodeType === Node.DOCUMENT_FRAGMENT_NODE && (f = f.host)) for (f = Tf(f).is, f !== g && Zf(e, g, f), e = window.ShadyDOM.nativeMethods.querySelectorAll.call(e, ":not(." + W.a + ")"), f = 0; f < e.length; f++) {
              if (g = e[f], h = g.getRootNode().host) h = Tf(h).is, Xf(g, h);
            }
          }
        }
      }
    ...
    if (!U) {
      var Wg = new MutationObserver(Vg),
          Xg = function Xg(a) {
        Wg.observe(a, { childList: !0, subtree: !0 });
      };if (window.customElements && !window.customElements.polyfillWrapFlushCallback) Xg(document);else {
        var Yg = function Yg() {
          Xg(document.body);
        };window.HTMLImports ? window.HTMLImports.whenReady(Yg) : requestAnimationFrame(function () {
          if ("loading" === document.readyState) {
            var a = function a() {
              Yg();document.removeEventListener("readystatechange", a);
    ...
    var Zg = Ug;var $g = {};var ah = Promise.resolve();function bh(a) {
      if (a = $g[a]) a._applyShimCurrentVersion = a._applyShimCurrentVersion || 0, a._applyShimValidatingVersion = a._applyShimValidatingVersion || 0, a._applyShimNextVersion = (a._applyShimNextVersion || 0) + 1;
    }function ch(a) {
      return a._applyShimCurrentVersion === a._applyShimNextVersion;
    }function dh(a) {
      a._applyShimValidatingVersion = a._applyShimNextVersion;a.b || (a.b = !0, ah.then(function () {
        a._applyShimCurrentVersion = a._applyShimNextVersion;a.b = !1;
      }));
    }var eh = new Tg();function Y() {
      this.G = {};this.c = document.documentElement;var a = new af();a.rules = [];this.f = zg(this.c, new yg(a));this.m = !1;this.b = this.a = null;
    ...
    r.prepareTemplateStyles = function (a, b, c) {
      if (!a.m) {
        a.m = !0;a.name = b;a.extends = c;$g[b] = a;var d = (d = a.content.querySelector("style")) ? d.getAttribute("css-build") || "" : "";var e = [];for (var f = a.content.querySelectorAll("style"), g = 0; g < f.length; g++) {
          ...
          ib: d };fh(this);f = Ef.test(e) || Df.test(e);Ef.lastIndex = 0;Df.lastIndex = 0;e = bf(e);f && V && this.a && this.a.transformRules(e, b);a._styleAst = e;a.G = d;d = [];V || (d = Dg(a._styleAst));if (!d.length || V) e = U ? a.content : null, b = Qg[b], f = ag(c, a._styleAst), b = f.length ? Of(f, c.is, e, b) : void 0, a.a = b;a.f = d;
      }
    };r.prepareTemplateDom = function (a, b) {
      U || a.c || (a.c = !0, Vf(a.content, b));
    };
    function gh(a) {
      ...
      !a.a && window.ShadyCSS && window.ShadyCSS.ApplyShim && (a.a = window.ShadyCSS.ApplyShim, a.a.invalidCallback = bh);gh(a);
    }
        ...
        var a = this.b.processStyles();if (this.b.enqueued) {
          if (V) for (var b = 0; b < a.length; b++) {
            var c = this.b.getStyleForCustomStyle(a[b]);if (c && V && this.a) {
              var d = Mf(c);fh(this);this.a.transformRules(d);c.textContent = Kf(d);
            }
          } else for (hh(this, this.c, this.f), b = 0; b < a.length; b++) {
            (c = this.b.getStyleForCustomStyle(a[b])) && Og(c, this.f.O);
    ...
    r.styleElement = function (a, b) {
      var c = Tf(a).is,
          d = X(a);if (!d) {
        var e = Tf(a);d = e.is;e = e.X;var f = Qg[d];d = $g[d];if (d) {
          var g = d._styleAst;var h = d.f;
        }d = zg(a, new yg(g, f, h, e));
        ...
        }if (((k = $g[c]) || a === this.c) && k && k.a && !ch(k)) {
          if (ch(k) || k._applyShimValidatingVersion !== k._applyShimNextVersion) fh(this), this.a && this.a.transformRules(k._styleAst, c), k.a.textContent = ag(a, d.M), dh(k);U && (c = a.shadowRoot) && (c.querySelector("style").textContent = ag(a, d.M));d.M = k._styleAst;
        }
      } else if (this.flush(), hh(this, a, d), d.pa && d.pa.length) {
        c = d;k = Tf(a).is;d = (b = eh.fetch(k, c.O, c.pa)) ? b.styleElement : null;g = c.I;(h = b && b.I) || (h = this.G[k] = (this.G[k] || 0) + 1, h = k + "-" + h);c.I = h;h = c.I;e = Pg;e = d ? d.textContent || "" : Lg(e, a, c.O, h);f = X(a);var m = f.a;m && !U && m !== d && (m._useCount--, 0 >= m._useCount && m.parentNode && m.parentNode.removeChild(m));U ? f.a ? (f.a.textContent = e, d = f.a) : e && (d = Of(e, h, a.shadowRoot, f.b)) : d ? d.parentNode || (Bg && -1 < e.indexOf("@media") && (d.textContent = e), Pf(d, null, f.b)) : e && (d = Of(e, h, null, f.b));d && (d._useCount = d._useCount || 0, f.a != d && d._useCount++, f.a = d);h = d;U || (d = c.I, f = e = a.getAttribute("class") || "", g && (f = e.replace(new RegExp("\\s*x-scope\\s*" + g + "\\s*", "g"), " ")), f += (f ? " " : "") + "x-scope " + d, e !== f && Sf(a, f));b || eh.store(k, c.O, h, c.I);
      }
    };function ih(a, b) {
      return (b = b.getRootNode().host) ? X(b) ? b : ih(a, b) : a.c;
    }
    function hh(a, b, c) {
      a = ih(a, b);var d = X(a);a = Object.create(d.O || null);var e = Kg(b, c.M);b = Ig(d.M, b).L;Object.assign(a, e.Ta, b, e.Za);b = c.T;for (var f in b) {
        if ((e = b[f]) || 0 === e) a[f] = e;
      }f = Pg;b = Object.getOwnPropertyNames(a);for (e = 0; e < b.length; e++) {
        d = b[e], a[d] = Gg(f, a[d], a);
      }c.O = a;
    ...
    r.styleSubtree = function (a, b) {
      ...
      var b = this,
        ...
        if (U) vg(a);else {
          var c = W;a.selector = a.parsedSelector;vg(a);a.selector = a.F = eg(c, a, c.c, void 0, void 0);
        }V && (fh(b), b.a && b.a.transformRule(a));
      });V ? a.textContent = Kf(c) : this.f.M.rules.push(c);
    };
    r.getComputedStyleValue = function (a, b) {
      var c;V || (c = (X(a) || X(ih(this, a))).O[b]);return (c = c || window.getComputedStyle(a).getPropertyValue(b)) ? c.trim() : "";
    };r.ab = function (a, b) {
      ...
      }c && b.push(W.a, c);V || (c = X(a)) && c.I && b.push(Pg.a, c.I);Sf(a, b.join(" "));
    };r.Ma = function (a) {
      return X(a);
    };Y.prototype.flush = Y.prototype.flush;
    Y.prototype.prepareTemplate = Y.prototype.prepareTemplate;Y.prototype.styleElement = Y.prototype.styleElement;Y.prototype.styleDocument = Y.prototype.styleDocument;Y.prototype.styleSubtree = Y.prototype.styleSubtree;Y.prototype.getComputedStyleValue = Y.prototype.getComputedStyleValue;Y.prototype.setElementClass = Y.prototype.ab;Y.prototype._styleInfoForNode = Y.prototype.Ma;Y.prototype.transformCustomStyleForDocument = Y.prototype.Aa;Y.prototype.getStyleAst = Y.prototype.Ra;Y.prototype.styleAstToString = Y.prototype.bb;
    Y.prototype.flushCustomStyles = Y.prototype.flushCustomStyles;Object.defineProperties(Y.prototype, { nativeShadow: { get: function get$$1() {
        ...
        jh,
        kh;window.ShadyCSS && (jh = window.ShadyCSS.ApplyShim, kh = window.ShadyCSS.CustomStyleInterface);
    window.ShadyCSS = { ScopingShim: Z, prepareTemplate: function prepareTemplate(a, b, c) {
      ...
      }, nativeCss: V, nativeShadow: U };jh && (window.ShadyCSS.ApplyShim = jh);kh && (window.ShadyCSS.CustomStyleInterface = kh);(function (a) {
      function b(a) {
  ...
  continue;
              ...
              if (":" != l || ua) {
                ...
                } else "\t" != l && "\n" != l && "\r" != l ? ("[" == l ? ua = !0 : "]" == l && (ua = !1), q += l) : h("Invalid code point in host/hostname: " + l);
  ...
  if (D = n[q.toLowerCase()]) q = D;".." == q ? (this.l.pop(), "/" != l && "\\" != l && this.l.push("")) : "." == q && "/" != l && "\\" != l ? this.l.push("") : "." != q && ("file" == this.h && 0 == this.l.length && 2 == q.length && p.test(q[0]) && "|" == q[1] && (q = q[0] + ":"), this.l.push(q));q = "";"?" == l ? (this.u = "?", k = "query") : "#" == l && (this.C = "#", k = "fragment");
        ...
        void 0 === b || b instanceof g || (b = new g(String(b)));this.Na = a;f.call(this);a = a.replace(/^[ \t\r\n\f]+|[ \t\r\n\f]+$/g, "");e.call(this, a, null, b);
      }var h = !1;if (!a.rb) try {
        ...
        m.ftp = 21;m.file = 0;m.gopher = 70;m.http = 80;m.https = 443;m.ws = 80;m.wss = 443;var n = Object.create(null);n["%2e"] = ".";n[".%2e"] = "..";n["%2e."] = "..";n["%2e%2e"] = "..";var p = /[a-zA-Z]/,
            ...
            if (this.i) return this.Na;var a = "";if ("" != this.v || null != this.g) a = this.v + (null != this.g ? ":" + this.g : "") + "@";return this.protocol + (this.D ? "//" + a + this.host : "") + this.pathname + this.u + this.C;
          }, set href(a) {
      ...
      }, configurable: !0, enumerable: !0 });var lh = document.createElement("style");lh.textContent = "body {transition: opacity ease-in 0.2s; } \nbody[unresolved] {opacity: 0; display: block; overflow: hidden; position: relative; } \n";var mh = document.querySelector("head");mh.insertBefore(lh, mh.firstChild);var nh = window.customElements,
        oh = !1,
        ph = null;nh.polyfillWrapFlushCallback && nh.polyfillWrapFlushCallback(function (a) {
      ph = a;oh && a();
    });function qh() {
      window.HTMLTemplateElement.bootstrap && window.HTMLTemplateElement.bootstrap(window.document);ph && ph();oh = !0;window.WebComponents.ready = !0;document.dispatchEvent(new CustomEvent("WebComponentsReady", { bubbles: !0 }));
    }
    "complete" !== document.readyState ? (window.addEventListener("load", qh), window.addEventListener("DOMContentLoaded", function () {
      window.removeEventListener("load", qh);qh();
    })) : qh();
  }).call(undefined);
